...
const WhatsAppButton = () => {
  ...
  return (
    <Button
      ...
      className="fixed bottom-6 right-6 h-16 w-16 rounded-full shadow-2xl z-50 bg-green-500 hover:bg-green-600 text-white p-0 animate-bounce hover:animate-none transition-all duration-300 hover:scale-110"
      size="icon"
