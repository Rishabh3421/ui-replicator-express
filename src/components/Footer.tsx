      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="animate-fade-in-left">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-footer-foreground/80">
                  Educational Consultant
                </p>
              </div>
            </div>
            <p className="text-sm text-footer-foreground/80 mb-6 leading-relaxed">
              Your trusted partner for visa and immigration services. We help
              build futures with personalized guidance and transparent
              processes.
            </p>
          ...
          <div className="animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-footer-foreground/80 hover:text-accent transition-colors duration-300 cursor-pointer">
                Student Visa
              </li>
              <li className="text-footer-foreground/80 hover:text-accent transition-colors duration-300 cursor-pointer">
                Work Visa
          ...
          <div className="animate-fade-in" style={{ animationDelay: "0.4s" }}>
            ...
            <div className="space-y-4 text-sm">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-footer-foreground/80">
                    Mahalaxmi Nagar, Vijay Nagar, Indore, Madhya Pradesh -
                    452010
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-footer-foreground/80">
                    9050519168, 8950023501, 8396000445
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
          ...
          >
            ...
            <div className="space-y-4 text-sm text-footer-foreground/80">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <p>
                  Opposite Bus Stand, Shop No.18, Municipal Committee, Indri -
                  132041
                </p>
              </div>
            </div>
        ...
        <div className="border-t border-footer-foreground/20 mt-12 pt-6 text-center">
          <p className="text-sm text-footer-foreground/60 leading-relaxed">
            <strong>Disclaimer:</strong> Easy World Educational Consultant is an
            independent consultancy providing visa and immigration guidance. We
            are not affiliated with any government authority.
          </p>
          <p className="text-xs text-footer-foreground/50 mt-2">
            Copyright © 2024 Easy World Educational Consultant. All rights
            reserved.
          </p>
        </div>
      </div>
